...
class PlatformFFI {
  ...
  static Future<Null> init() async {
    ...
    try {
      ...
      _startListenEvent(HoptodeskImpl(dylib));
      try {
  ...
  static void _startListenEvent(HoptodeskImpl hoptodeskImpl) {
    () async {
      await for (final message in hoptodeskImpl.startEventStream()) {
    ...
    () async {
      await for (final rgba in hoptodeskImpl.startRgbaStream()) {
